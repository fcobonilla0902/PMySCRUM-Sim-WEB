...
function updateDashboard() {
    ...
    // Actualizar título según metodología
...
function guardarResultadosEnBD(resultadoFinal) {
    ...
    const tipo = metodologia === 'scrum' ? 0 : 1;
...
function cargarDatosEscenario() {
    ...
    // Leer metodología 
    metodologiaActual = urlParams.get('metodologia') || 'scrum';
    ...
    scenarioTitleEl.textContent = `SIMULACIÓN SCRUM: SPRINT ${proyectoActual.getCurrentSprint()}`;
}
